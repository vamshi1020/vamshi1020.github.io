        ...
        $map.slideToggle({
            complete: function() {
                ...
                if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                        el: '#gmap-wrapper',
                        lat: 39.257394, //Replace Here Location Google Map Lat
                        lng: -76.698488, //Replace Here Location Google Map Lng
                        scrollwheel: false,
                        zoom: 17,
                        zoomControl: true,
                        panControl: true,
                    ...
                    map.addMarker({
                        lat: 39.257394, //Replace Here Location Google Map Lat
                        lng: -76.698488, //Replace Here Location Google Map Lat
                        icon: image,
